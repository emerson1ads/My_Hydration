...
const Copo = () => {
  const { aguaSalva, setAguaSalva, quantidadeAdicional, setQuantidadeAdicional } = useDataContext();
  ...
  function salvarResultadoEditado() {
    try {
      ...
      setAguaSalva(resultadoFinal);
      setQuantidadeAdicional(valorAdicional);
